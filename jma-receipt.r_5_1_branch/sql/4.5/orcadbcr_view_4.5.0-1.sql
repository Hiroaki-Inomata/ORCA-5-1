...
COMMENT 
        ON VIEW view_bd002 IS '収納ビュー2';


CREATE view view_q002 as
SELECT b.hospnum, b.ptid, b.nyugaikbn, a.sryka, a.srykbn, a.srysyukbn, b.sryymd, a.srycd1, a.srycd2, a.srycd3, a.srycd4, a.srycd5
   FROM tbl_sryact a, tbl_jyurrk b
  WHERE a.hospnum  = b.hospnum::smallint AND a.ptid = b.ptid::bigint AND a.nyugaikbn = b.nyugaikbn AND a.sryka = b.sryka AND (a.zainum::numeric = b.zainum1 OR a.zainum::numeric = b.zainum2 OR a.zainum::numeric = b.zainum3 OR a.zainum::numeric = b.zainum4 OR a.zainum::numeric = b.zainum5 OR a.zainum::numeric = b.zainum6 OR a.zainum::numeric = b.zainum7 OR a.zainum::numeric = b.zainum8 OR a.zainum::numeric = b.zainum9 OR a.zainum::numeric = b.zainum10 OR a.zainum::numeric = b.zainum11 OR a.zainum::numeric = b.zainum12 OR a.zainum::numeric = b.zainum13 OR a.zainum::numeric = b.zainum14 OR a.zainum::numeric = b.zainum15)
UNION ALL 
 SELECT a.hospnum, a.ptid, '1' AS nyugaikbn, b.sryka, b.srykbn, '   '::bpchar AS srysyukbn, a.sryymd, b.srycd AS srycd1, b.srycd AS srycd2, b.srycd AS srycd3, b.srycd AS srycd4, b.srycd AS srycd5
   FROM tbl_nrrksrh a, tbl_nsrysrh b
