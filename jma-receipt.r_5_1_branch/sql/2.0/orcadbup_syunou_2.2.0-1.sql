...
KYUFUGAI_GOKEI_TEN		numeric(07),
DAYINFFLG			char(01),
NYUIN_RRKNUM			numeric(03) default 0,
ACCT_UPDKBN			char(01)    default ' ',
TERMID                          varchar(16),
OPID    			varchar(16),
CREYMD  			char(8),
UPYMD    			char(8),
...
RJN_FTN,KOH_FTN,YKZ_FTN,RESE_YKZ_FTN,KOHTAIYKZKBN,CHOSEI,SECMONEY,
...
from 
(select hospid,ptid,rrknum,nyuinymd,taiinymd
 from tbl_ptnyuinrrk group by hospid,ptid,rrknum,nyuinymd,taiinymd ) a
 where tbl_syunou.hospid     = a.hospid
   and tbl_syunou.nyugaikbn  = '1'
   and tbl_syunou.ptid       = a.ptid
   and tbl_syunou.createkbn <> '3'
   and tbl_syunou.skystymd  >= a.nyuinymd
   and tbl_syunou.skyedymd  <= a.taiinymd;
