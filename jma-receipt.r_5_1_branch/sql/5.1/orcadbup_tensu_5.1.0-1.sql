...
ALTER TABLE master.tbl_tensu_master ADD COLUMN akuseibyoriksn smallint default 0;
ALTER TABLE public.tbl_tensu_user ADD COLUMN akuseibyoriksn smallint default 0;
