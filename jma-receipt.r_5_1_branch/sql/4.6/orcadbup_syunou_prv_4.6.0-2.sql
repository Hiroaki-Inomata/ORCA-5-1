...
ALTER TABLE tbl_syunou_prv DROP CONSTRAINT tbl_syunou_prv_primary_key;
ALTER TABLE tbl_syunou_prv RENAME TO wrk_syunou_prv;
...
insert into tbl_syunou_prv select * from wrk_syunou_prv;
ALTER TABLE ONLY tbl_syunou_prv
ADD CONSTRAINT tbl_syunou_prv_primary_key PRIMARY KEY (hospnum, nyugaikbn, ptid, denpnum, creymd);
drop table wrk_syunou_prv;
